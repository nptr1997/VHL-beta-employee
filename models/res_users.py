...
class User(models.Model):
    ...
    #Thông tin cá nhân
    children_info = fields.Char(related='employee_id.children_info', readonly=False, related_sudo=False)
    children_birth = fields.Char(related='employee_id.children_birth', readonly=False, related_sudo=False)
    citizen_iden = fields.Char(related='employee_id.citizen_iden', readonly=False, related_sudo=False)
    date_of_citizen = fields.Date(related='employee_id.date_of_citizen', readonly=False, related_sudo=False)
    place_of_citizen = fields.Char(related='employee_id.place_of_citizen', readonly=False, related_sudo=False)
    permanent_address = fields.Char(related='employee_id.permanent_address', readonly=False, related_sudo=False)
    temporary_address = fields.Char(related='employee_id.temporary_address', readonly=False, related_sudo=False)
    relation_phone = fields.Char(related='employee_id.relation_phone', readonly=False, related_sudo=False)
    #-----Hết
    # Thông tin làm việc-----Bổ sung thêm trường
    employee_code = fields.Char(related='employee_id.employee_code', readonly=False, related_sudo=False)
    employee_position = fields.Selection(related='employee_id.employee_position', readonly=False, related_sudo=False)
    employee_group = fields.Char(related='employee_id.employee_group', readonly=False, related_sudo=False)
    employee_company_phone = fields.Char(related='employee_id.employee_company_phone', readonly=False, related_sudo=False)
    employee_onboard_date = fields.Date(related='employee_id.employee_onboard_date', readonly=False, related_sudo=False)
    employee_offboard_date = fields.Date(related='employee_id.employee_offboard_date', readonly=False, related_sudo=False)
    employ_detail_job = fields.Selection(related='employee_id.employ_detail_job', readonly=False, related_sudo=False)
    employee_work_place = fields.Selection(related='employee_id.employee_work_place', readonly=False, related_sudo=False)
    employee_bank_account = fields.Char(related='employee_id.employee_bank_account', readonly=False, related_sudo=False)
    employee_bank = fields.Char(related='employee_id.employee_bank', readonly=False, related_sudo=False)
    employee_tax_code = fields.Char(related='employee_id.employee_tax_code', readonly=False, related_sudo=False)
    employee_social_insurance = fields.Char(related='employee_id.employee_social_insurance', readonly=False, related_sudo=False)
    employee_leave = fields.Boolean(related='employee_id.employee_leave', readonly=False, related_sudo=False)
    # -----Hết
